"""
Django settings for trainsite project.
...
MEDIA_ROOT = os.path.join(BASE_DIR, 'media') #media - folder in directory of project!(base_dir it define) import os (line 12)
MEDIA_URL = '/media/' #add prefix to url of graphic files
